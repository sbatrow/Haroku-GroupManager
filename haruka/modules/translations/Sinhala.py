...
INSULTS_STRINGS = (
   "අපොයි ... එවැනි මෝඩ මෝඩයෙක්.",
    ...
    "මම කියන්නේ නැහැ ඔයා මෝඩයි කියලා, මම කියන්නේ හිතනකොට ඔයාට නරක වාසනාවක් ලැබුණා කියලයි.",
   ...
   "තුවක්කුවක් අරගෙන ඔබටම වෙඩි තියන්න.",
    ...
    "ඔබ හිරු මත පය තබන පළමු පුද්ගලයා විය හැකිය. උත්සාහ කර බලන්න.",
)
...
MARKDOWN_HELP = """
මාර්ක්ඩවුන් යනු විදුලි පණිවුඩ මඟින් සහාය දක්වන ඉතා ප්‍රබල හැඩතල ගැන්වීමේ මෙවලමකි. { } සමහර වැඩි දියුණු කිරීම් ඇත, එය තහවුරු කර ගැනීම සඳහා \
...
මම කණ්ඩායම් කළමනාකරු බොට් විසින් නඩත්තු කරනු ලැබේ[this person](tg://user?id={654839744}). I'm a [Marie](https://github.com/PaulSonOfLars/tgbot) fork.
මම පයිතන් 3 හි , ඉදිකර ඇත \
python-telegram-bot library, and am fully opensource - you can find what makes me tick\
[here](https://github.com/peaktogoo/HarukaAya))!

ගිතුබ් වෙතින් ඉල්ලීම් ඉදිරිපත් කිරීමට හෝ මගේ සහායක කණ්ඩායම වන @EchelonTeam, ඕනෑම දෝෂ, ප්‍රශ්න සමඟ සම්බන්ධ වීමට නිදහස් වන්න.
...
- / start: බොට් ජීවතුන් අතර සිටීද යන්න පරීක්ෂා කිරීමට සිසිල් විධානය
 ...
 - / help <මොඩියුලයේ නම>: අගමැති ඔබ එම මොඩියුලය පිළිබඳ තොරතුරු.
